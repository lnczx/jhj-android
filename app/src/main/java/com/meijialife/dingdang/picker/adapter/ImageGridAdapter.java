...
import com.meijialife.dingdang.picker.view.SquaredSimpleDraweeView;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    private boolean showCamera = true;//默认显示照相机按钮
    private boolean showSelectIndicator = true;//默认显示指示圆点
    ...
    class ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            mIndicator = (ImageView) view.findViewById(R.id.checkmark);
        ...
        void bindData(final Image data) {
            ...
            if (imageFile.exists()) {
                ...
                ImageLoaderUtil.getInstance().loadImage(mContext, new ImageLoader.Builder()
                        .path(data.path).widthAndHeight(200)
                        .placeHolder(R.drawable.mis_default_error)
                        .mImageView(mImage).build());
            } else {
                ImageLoaderUtil.getInstance().loadImage(mContext, new ImageLoader.Builder()
                        .widthAndHeight(200)
                        .placeHolder(R.drawable.mis_default_error)
