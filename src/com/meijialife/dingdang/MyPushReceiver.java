...
public class MyPushReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		case PushConsts.GET_MSG_DATA:
			...
			if (payload != null) {
				...
				try {
					receiverBean = new Gson().fromJson(data,
							new TypeToken<ReceiverBean>() {
							}.getType());
				} catch (Exception e) {
					e.printStackTrace();
				}
				if (null != receiverBean) {
					...
					// 弹出大屏闹钟
					AlermDialog dlg = new AlermDialog(context,
							receiverBean.getRemind_title(),
							receiverBean.getRemind_content(),action);
					dlg.show();
					...
					// AlermDialog dlg = new AlermDialog(context,
					// receiverBean.getRemind_title(),
					// receiverBean.getRemind_content());
					// dlg.show();
					// AlermUtils.playAudio(context);
					//
					// } else
					// if (StringUtils.isEquals(receiverBean.getAction(),
					// ACTION_DISPATCH)) {
					// // 弹出大屏闹钟
					// AlermDialog dlg = new AlermDialog(context,
					// receiverBean.getRemind_title(),
					...
					// dlg.show();
					// AlermUtils.playAudio(context);
					// } else if (StringUtils.isEquals(receiverBean.getAction(),
					// ACTION_MSG)) {
					// // 弹出大屏闹钟
					// AlermDialog dlg = new AlermDialog(context,
					// receiverBean.getRemind_title(),
	...
	private void setNotification(ReceiverBean receiverBean) {
		...
		builder.setLargeIcon(BitmapFactory.decodeResource(
				mContext.getResources(), R.drawable.ic_launcher_logo));
